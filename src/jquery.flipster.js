    ...
    $.fn.flipster = function (options) {
        ...
        return this.each(function () {
            ...
            function buildButton(dir) {
                ...
                return $('<button data-dir="' + dir + '" class="' + classes.button + ' ' + ( dir === 'next' ? classes.buttonNext : classes.buttonPrev ) + '" role="button" />')
                    .html(buildButtonContent(dir));

            }

            function buttonClickHandler(e) {
                var dir = $(this).attr('data-dir') || 'next';
                jump(dir);
                e.preventDefault();
            }
            ...
            function buildButtons() {
                if (settings.buttons && _items.length > 1) {
                    ...
                    self.on('click', 'button', buttonClickHandler);
                }
            }
            ...
            function index() {
                ...
                if (settings.click) {
                    _items.on('click.flipster touchend.flipster', itemClickHandler);
                }
            ...
            function dispose() {
                console.log("dispose");
                self.off('click');
                _items.off('click.flipster touchend.flipster');
